...
const TitulacionesTipo = () => {
    ...
    const fetchData = async () => {
        const { data, totalPages, totalItems, page } = await fetchAPIData('/silefe.titulaciontipo/filter', formatPost(items), referer);
        const tmp = await data.map(i => ({ ...i, id: i.titulacionTipoId, checked: false }) );
