...
const PerDiscapacidad = () => {
    ...
    const referer = `${url_referer}/perdiscapacidad`;
    ...
    const handleSave = async () => {
        ...
        let endpoint = '/silefe.porcentajediscapacidad/save-discapacidad';
        if (items.status === 'new')
            endpoint = '/silefe.porcentajediscapacidad/add-discapacidad';
    ...
    const confirmDelete = async () => {
        const endpoint = '/silefe.porcentajediscapacidad/delete-discapacidades';
    ...
    const fetchData = async () => {
        const { data, totalPages, totalItems, page } = await fetchAPIData('/silefe.porcentajediscapacidad/filter', formatPost(items), referer);
...
export default PerDiscapacidad;
