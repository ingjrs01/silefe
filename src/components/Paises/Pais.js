...
const Pais = () => {
    ...
    const handleSave = async () => {
        ...
        let endpoint = '/silefe.paises/save-pais'
        if (items.status === 'new')
            endpoint = '/silefe.paises/add-pais';
    ...
    const confirmDelete = async () => {
        const endpoint = '/silefe.paises/remove-paises';
    ...
    const fetchData = async () => {
        const { data, totalPages, totalItems, page } = await fetchAPIData('/silefe.paises/filter', formatPost(items), referer);
