                    ...
                    <ClayTable>
                        ...
                        <ClayTable.Head>
                            <ClayTable.Row> <ClayTable.Cell headingCell><ClayCheckbox checked={false} onChange={() => console.log("lalala")} /> </ClayTable.Cell>
                                <ClayTable.Cell expanded headingCell>{"Nombre"}</ClayTable.Cell>
                                <ClayTable.Cell expanded headingCell>{"Apellido 1"}</ClayTable.Cell>
                        ...
                        <ClayTable.Body>
                            {redParticipantes.items.map((item, index) => {
                                return (
                                    <>
                                        <ClayTable.Row>
