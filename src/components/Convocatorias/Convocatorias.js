...
import { exportToCsv, formatPost, toURL } from '../../includes/utils';
...
const Convocatorias = () => {
    ...
    const downloadFile = async () => {
        fetchAPIData('/silefe.convocatoria/filter', formatPost(items,false), referer).then(({data}) => { 
            exportToCsv(data,  items.fields.table, "convocatorias.csv");    
        });
    }
