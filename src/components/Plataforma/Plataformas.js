...
const Plataformas = () => {
    ...
    const referer = `${url_referer}/prestaciones`;
    ...
    const handleSave = async () => {
        ...
        let endpoint = '/silefe.plataforma/save-plataforma';
        if (items.status === 'new')
            endpoint = '/silefe.plataforma/add-plataforma';
    ...
    const confirmDelete = async () => {
        const endpoint = '/silefe.plataforma/remove-plafaformas';
    ...
    const fetchData = async () => {
        const { data, totalPages, totalItems, page } = await fetchAPIData('/silefe.plataforma/filter', formatPost(items), referer);
