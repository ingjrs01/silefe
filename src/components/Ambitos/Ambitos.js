...
const Ambitos = () => {
    ...
    const downloadFile = () => {
        fetchAPIData('/silefe.ambito/filter', formatPost(items,false), referer).then(({data}) => { 
    ...
    const fetchData = async () => {
        let { data, totalPages, totalItems, page } = await fetchAPIData('/silefe.ambito/filter', formatPost(items), referer);
