...
const Situaciones = () => {
    ...
    const handleSave = async () => {
        ...
        let endpoint = '/silefe.situacioneslab/save-situacion'
        if (items.status === 'new')
            endpoint = '/silefe.situacioneslab/add-situacion';
    ...
    const confirmDelete = async () => {
        const endpoint = '/silefe.situacioneslab/delete-situaciones';
    ...
    const fetchData = async () => {
        const { data, totalPages, totalItems, page } = await fetchAPIData('/silefe.situacioneslab/filter', formatPost(items), referer);
