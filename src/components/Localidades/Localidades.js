...
const Localidades = () => {
    ...
    const handleSave = async () => {
        ...
        //    userId:     getUserId(),
        //}
        let endpoint = '/silefe.localidad/save-localidad'
        if (items.status === 'new') 
            endpoint = '/silefe.localidad/add-localidad';
    ...
    const confirmDelete = async () => {
        const endpoint = '/silefe.localidad/remove-localidades';
    ...
    const fetchData = async () => {
        const endpoint   = '/silefe.localidad/filter';
        const postdata = {
            localidad: (items.search && typeof items.search !== 'undefined')?items.search:"",
            page: items.page,
        };
